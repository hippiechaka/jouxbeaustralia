...
<body style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; color:#666">
    <div style="width:700px; margin:0 auto; ">
    	<img src="{dominio}/images/layout/header/mainlogo_flat.png" width="232" height="88" alt="JOUXBE" />
        <h2 style="width:350px; color:#00A4D1; float:right; text-align:right; ">INFORMACIÓN DE CONTACTO</h2>
        <div style="clear:both"></div>
        <center><img src="{dominio}/images/layout/header/sep_menu.png" width="840" height="15" /></center><br />
