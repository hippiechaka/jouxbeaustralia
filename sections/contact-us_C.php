...
<div id="contacto" align="left">
                        ...
                        <div id="forma_envio">
                            ...
                            <form action="envia_mail.php" method="post" id="forma_contacto" >
                                ...
                                <!-- <label><span style="color:#ef9863;">*</span> Activity:</label>
                                <select id="activity" name="activity" style="width:320px; margin:8px 0 7px 7px; float:right" title="Select one Activity">
                                    <option value="No selection">Select one Activity</option>
